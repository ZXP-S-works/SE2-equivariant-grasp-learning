...
from utils.torch_utils import perturb, ExpertTransition
import matplotlib.pyplot as plt

class Base4D(BaseAgent):
    def __init__(self, workspace, heightmap_size, device, lr=1e-4, gamma=0.9, sl=False, num_primitives=1,
                 patch_size=24, num_rz=8, rz_range=(0, 7*np.pi/8), num_zs=16, z_range=(0.02, 0.12)):
        ...
        self.gripper_clearance = 0.015 - 0.005  # ToDo check with the env
        self.aug = False
